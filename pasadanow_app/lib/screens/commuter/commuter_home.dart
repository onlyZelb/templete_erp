...
// ─────────────────────────────────────────────────────────────────────────────
// FARE CONFIG MODEL  (mirrors driver.dart exactly)
// ─────────────────────────────────────────────────────────────────────────────
...
class FareConfig {
  ...
  /// Fallback defaults matching old hardcoded values
...
class _CommuterHomeState extends State<CommuterHome>
  ...
  // ── Fare config (mirrors driver.dart) ─────────────────────────────────────
  ...
  /// Uses live FareConfig — mirrors driver.dart computeFare exactly
  ...
  void initState() {
    ...
    // Refresh fare config every 60 s so admin changes propagate
  ...
  /// Load fare config from the same Django endpoint as the driver
  ...
  AppBar _buildAppBar(AuthProvider auth) {
    ...
    return AppBar(
      ...
      actions: [
        ...
        // ── Fare config badge (mirrors driver appbar badge) ───────────
        GestureDetector(
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: _o(_fareConfig.surgeEnabled ? _orange : _accent, 0.45),
                  width: 1.5,
                ),
              ),
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: _fareConfig.surgeEnabled ? _orange : _textSub,
                      fontSize: 7,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
  ...
  // ══════════════════════════════════════════════════════════════════════
  //  FARE METRICS PANEL  ← Updated to match driver.dart exactly
  // ══════════════════════════════════════════════════════════════════════
  ...
  Widget _fareMetricsPanel() {
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          // ── Header with live rate badge (mirrors driver earnings tab) ──
          Row(children: [
          ...
          // ── Fare breakdown (mirrors driver _fareBreakdownBanner) ────
          Container(
          ...
          // ── Formula line (mirrors driver earnings tab) ──────────────
          Text(
