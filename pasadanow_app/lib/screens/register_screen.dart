...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  // Store XFile for reference + Uint8List bytes for web-safe preview
  XFile? _profilePhoto;
  XFile? _licensePhoto;
  XFile? _vehiclePhoto;
  ...
  Future<void> _pickImage({required _ImageSlot slot}) async {
    ...
    // readAsBytes() works on both web and mobile — do it once here
  ...
  Future<ImageSource?> _showImageSourceDialog() async {
    // Web doesn't support camera source — skip the dialog
  ...
  Future<void> _register() async {
    ...
    try {
      // Bytes already read at pick time — just base64-encode them here
