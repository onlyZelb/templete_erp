...
class _DriverHomeState extends State<DriverHome>
  ...
  Future<void> _loadFareConfig() async {
    ...
    try {
      ...
      if (data != null && data is Map<String, dynamic> && mounted) {
        ...
        // Notify if surge just turned on
  ...
  Future<void> _acceptRide(RideRequest req) async {
    ...
    if (req.hasValidPickup && req.hasValidDropoff) {
      ...
      if (mounted) {
        _showSnack('Warning: ride has missing location data.', _orange);
      }
    }
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // APP BAR  ← NotificationBell replaces the plain IconButton
  // ─────────────────────────────────────────────────────────────────────────
        ...
        GestureDetector(
          ...
          child: Padding(
            ...
            child: Container(
              padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 3),
              decoration: BoxDecoration(
                color: _o(_fareConfig.surgeEnabled ? _orange : _accent, 0.15),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                    color:
                        _o(_fareConfig.surgeEnabled ? _orange : _accent, 0.45),
                    width: 1),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        color: _fareConfig.surgeEnabled ? _orange : _accent,
                        fontSize: 9,
                        fontWeight: FontWeight.w800),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                        color: _fareConfig.surgeEnabled ? _orange : _textMuted,
                        fontSize: 7,
                        fontWeight: FontWeight.w600),
                  ),
                ],
            ...
            if (_commuterLiveLocation != null && _activeRide != null)
              Marker(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Icon(Icons.person_pin_circle, color: _accent, size: 22),
                ]),
              ),
  ...
  Widget _mapBtn(IconData icon, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: Icon(icon, color: _textPrimary, size: 16)),
      ),
    );
  }
  ...
  Widget _fareBreakdownBanner(RideRequest ride) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: _o(_orange, 0.08),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: _o(_orange, 0.25)),
      ),
  ...
  Widget _fareBadge(double fare) {
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        const Icon(Icons.credit_card_outlined, color: _orange, size: 14),
        const SizedBox(width: 4),
        Text('₱${fare.toStringAsFixed(2)}',
            style: const TextStyle(
                color: _orange, fontWeight: FontWeight.w800, fontSize: 14)),
      ]),
    );
  }
  ...
  Widget _statCard({
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(label,
            style: const TextStyle(
                color: _textMuted, fontSize: 7, letterSpacing: 0.8)),
      ]),
    );
  }
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: _bgCard,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: _o(_accent, 0.3), width: 1),
            ),
            child:
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                if (_fareConfig.surgeEnabled)
                  Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      const Icon(Icons.bolt, color: _orange, size: 10),
              ...
              const Divider(color: Color(0xFF1E3A6E), height: 14),
              Text(
          ...
          const Row(children: [
            Icon(Icons.receipt_long_outlined, color: _textPrimary, size: 16),
            SizedBox(width: 7),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.logout_outlined, color: _red, size: 18),
                  SizedBox(width: 7),
                  Text('Sign Out',
                      style: TextStyle(
                          color: _red,
      ...
      child: Column(children: [
        ...
        Text(
          profile?.fullName.isNotEmpty == true
              ...
              : auth.username ?? 'Driver',
          style: const TextStyle(
              color: _textPrimary, fontSize: 17, fontWeight: FontWeight.w800),
          textAlign: TextAlign.center,
        ),
        const SizedBox(height: 2),
        Text('@${auth.username ?? ''}',
  ...
  Widget _buildDocumentsSection(DriverProfile? profile) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Icon(Icons.folder_outlined, color: _orange, size: 15),
          const SizedBox(width: 6),
              ...
              Row(children: [
                ...
                Flexible(
                  child: Text(
                    ...
                    style: TextStyle(
                        color: hasPhoto ? _green : _textMuted, fontSize: 10),
                    overflow: TextOverflow.ellipsis,
                  ),
                ),
              ]),
          ...
          return Padding(
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  Row(children: [
                    const Icon(Icons.edit_outlined, color: _accent, size: 17),
                    const SizedBox(width: 7),
                    Text(title,
                        style: const TextStyle(
                            color: _textPrimary,
                    ...
                    GestureDetector(
                      ...
                      child:
                          const Icon(Icons.close, color: _textMuted, size: 19),
                    ),
                  ]),
              ...
              Row(children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    if (cfg.surgeEnabled)
                      Row(mainAxisSize: MainAxisSize.min, children: [
                        const Icon(Icons.bolt, color: _orange, size: 9),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.close, color: _red, size: 15),
                          SizedBox(width: 5),
                          Text('Decline',
                              style: TextStyle(
                                  color: _red,
    ...
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Flexible(
          child: Text(label,
              style: TextStyle(
                  color: bold ? _textPrimary : _textMuted,
                  fontSize: 11,
        ...
        Text(value,
            style: TextStyle(
                color: valueColor ?? (bold ? _green : _textPrimary),
                fontSize: 11,
