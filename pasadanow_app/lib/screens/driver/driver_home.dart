...
class _DriverHomeState extends State<DriverHome>
  ...
  Future<void> _loadFareConfig() async {
    ...
    try {
      ...
      if (data != null && data is Map<String, dynamic> && mounted) {
        setState(() => _fareConfig = FareConfig.fromJson(data));
      }
    } catch (_) {}
  ...
  Future<void> _fetchRoute(LatLng from, LatLng to) async {
    // Guard: skip if either point is invalid (0,0)
    ...
    try {
      ...
      // Only set fallback points if both are valid
  ...
  // FIX: Guard route fetch with valid coordinate check
        ...
        GestureDetector(
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    _o(_gpsAccuracy != null ? _green : _orange, 0.15),
        ...
        GestureDetector(
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _o(
                    _fareConfig.surgeEnabled ? _orange : _accent, 0.15),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                    color: _o(
                        _fareConfig.surgeEnabled ? _orange : _accent,
                        0.45),
                    width: 1),
              ),
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        color: _fareConfig.surgeEnabled
                            ? _orange
                            : _accent,
                        fontSize: 9,
                        fontWeight: FontWeight.w800),
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // DASHBOARD TAB — FIX: active ride banner inside Expanded + scrollable
  // ─────────────────────────────────────────────────────────────────────────
  ...
  Widget _buildDashboardTab(AuthProvider auth) {
    return Column(children: [
      ...
      // Active ride banner: constrained max height + scrollable
      if (_activeRide != null)
        ConstrainedBox(
            ...
            child: Container(
              ...
              child: const Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('Calculating route…',
                    style:
                        TextStyle(color: _textPrimary, fontSize: 12)),
              ]),
            ),
          ),
        ),
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // ACTIVE RIDE BANNER — FIX: scrollable, compact, mobile-friendly
  // ─────────────────────────────────────────────────────────────────────────
      ...
      child: SingleChildScrollView(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          _routeLabel(Icons.radio_button_checked, _green, 'Pickup',
              ride.pickupLabel),
          const SizedBox(height: 4),
          _routeLabel(Icons.location_on_outlined, _red, 'Dropoff',
              ride.dropoffLabel),
          // ── Fare breakdown ───────────────────────────────────────────
          const SizedBox(height: 8),
          ...
          Row(
              ...
              children: [
                Text('Surge (×${multiplier.toStringAsFixed(1)})',
                    style:
                        const TextStyle(color: _orange, fontSize: 11)),
                    ...
                    if (_fareConfig.surgeEnabled)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: _o(_orange, 0.4)),
                        ),
                        child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
