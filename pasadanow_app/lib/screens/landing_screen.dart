...
class _LandingScreenState extends State<LandingScreen>
  ...
  Widget _buildPage(_OnboardPage page) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          // ── Floating emoji orb (SMALLER to save vertical space)
          AnimatedBuilder(
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(page.emoji,
                            style: const TextStyle(fontSize: 44)), // was 58
                      ),
                    ),
                  ],
                ),
          ...
          const SizedBox(height: 20),  // was 30
          ...
          Container(
            padding:
                const EdgeInsets.symmetric(vertical: 12, horizontal: 8), // was 16
            decoration: BoxDecoration(
  ...
  Widget _buildBottomBar(_OnboardPage page) {
    ...
    return Padding(
      padding: const EdgeInsets.fromLTRB(24, 8, 24, 28),  // was 12/36
      child: Column(
        children: [
          // Dots
          Row(
          ...
          const SizedBox(height: 16),  // was 22
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              padding: const EdgeInsets.symmetric(vertical: 15),  // was 17
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    page.accent,
          ...
          const SizedBox(height: 12),  // was 14
